...
export default function Footer() {
  return (
    <div>
       <footer className="my-container gradient text-white py-12 px-4 font-sans tracking-wide">
      <div className="text-center">
        <h1 className=" text-xl font-bold">Sustainable Is A Culture We Should All Invest In</h1>
        <ul className="flex flex-col justify-center items-center mt-8 space-y-6">
                ...
                <li className="flex items-start ">
                    ...
                    <a href="" className="text-white text-sm ml-3">
                        <strong>2302 Park Avenue W Hainesport,
        ...
        <ul className="flex flex-wrap justify-center gap-x-8 gap-4 my-8">
          ...
          <li><a href="" className="text-xl hover:text-gray-400">
            <svg xmlns="http://www.w3.org/2000/svg" className="inline w-7 h-7 bg-[#ae4040]" viewBox="0 0 24 24">
