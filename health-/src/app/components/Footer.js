  ...
  return (
    <>
      ...
      <footer className="w-full text-white">
        {/*      <!-- Main footer --> */}
        <div className="border-t border-[#832f2f] bg-[#c30404] pt-16 pb-12 text-sm">
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-4 gap-8 md:grid-cols-8 lg:grid-cols-10 ">
              <nav
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-all duration-300 hover:underline text-xs"
                    >
                  ...
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-all duration-300 hover:underline text-xs"
                    >
                      Best ENT Specialists in Karachi
                    </a>
                  </li>
                </ul>
              </nav>
                ...
                <ul>
                  ...
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-all duration-300 hover:underline text-xs"
                    >
                      Best Child Specialists in Lahore
                    </a>
                  </li>
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-all duration-300 hover:underline text-xs"
                    >
                      Best ENT Specialists in Lahore
                    </a>
                  </li>
                </ul>
              </nav>
                ...
                <ul>
                  ...
                  <li className="mb-2 leading-6">
                    <a
                      ...
                      className="transition-all duration-300 hover:underline text-xs"
                    >
                      Best Cardiologists in Islamabad
                    </a>
                  </li>
                  <li className="mb-2 leading-6">
                    <a
        ...
        {/*  <!-- Sub Footer --> */}
        <div className="py-4 text-sm border-t border-[#ff7272] bg-[#a00404]">
          <div className="container px-6 mx-auto">
            <div className="grid grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              <div className="col-span-2 md:col-span-4 lg:col-span-6">
              © 2024 OneClickDigital.com. All Rights Reserved.
              </div>
              <nav
              ...
              >
                ...
                <ul className="flex items-center justify-end gap-4">
                  <li>
                    <a
                      href="javascript:void(0)"
                      className="transition-colors duration-300 hover:text-[#1877F2] focus:text-[#1877F2]"
                    >
                      <svg
                  ...
                  <li>
                    <a
                      href="javascript:void(0)"
                      className="transition-colors duration-300 hover:text-[#1DA1F2] focus:text-[#1DA1F2]"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
                  ...
                  <li>
                    <a
                      href="javascript:void(0)"
                      className="transition-colors duration-300 hover:text-[#5865F2] focus:text-[#5865F2]"
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        fill="none"
