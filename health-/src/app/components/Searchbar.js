  ...
  return (
    <>
      <div className=" text-center px-24  ">
        ...
        <br />
        <p className=" text-red-600 font-bold">{line1}  <span className="text-black font-normal">{line2}.</span> </p>
        <p className="text-black font-normal">{line3}</p>
        <p  className="text-black font-normal mt-4">{line4}</p>
        <p  className="text-black font-normal">{line5}.</p>
        <p className="text-black font-normal  mt-4 mb-6">{line6}</p>
      </div>
